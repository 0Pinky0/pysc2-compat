...
class RunConfig(object):
    ...
    def replay_paths(self, replay_dir):
        """A generator yielding the full path to the replays under
        `replay_dir`."""
    ...
    def start(self, version=None, **kwargs):
        ...
        Find the version and run sc_process.StarcraftProcess.
        """
    ...
    @classmethod
    def priority(cls):
        """None means this isn't valid.

        Run the one with the max priority.
        """
        return None
