...
class ArgumentType(collections.namedtuple(
    ...
    def enum(cls, options, values):
        """Create an ArgumentType where you choose one of a set of known
        values."""
...
class Function(collections.namedtuple(
    ...
    def str(self, space=False):
        ...
        Set space=True to line them all up nicely.
        """
...
class Functions(object):
    ...
    Can't use namedtuple since python3 has a limit of 255 function
    arguments, so build something similar.
    """
...
class FunctionCall(collections.namedtuple(
    ...
    def init_with_validation(cls, function, arguments, raw=False):
        """Return a `FunctionCall` given some validation for the function and
        args.
